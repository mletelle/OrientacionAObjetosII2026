package unrn.punto2.vista;

import unrn.punto2.log.Log;
...
public class RadioCompetition {
    ...
    private List<Concurso> concursosAbiertos;

    public RadioCompetition(SistemaInscripcion sistema) {
    ...
    private void todosLosConcursos() {
        concursosAbiertos = sistema.concursos().obtenerConcursosAbiertos();
        comboBox.addItem("");
    ...
    private void saveInscription(String nombre, String apellido, String dni, String email, String telefono) {
        ...
        Concurso concursoElegido = concursosAbiertos.get(indiceSeleccionado - 1);

        sistema.inscribir(nombre, apellido, dni, email, telefono, concursoElegido);
        JOptionPane.showMessageDialog(this.contentPane, "Inscripción guardada");
    }
